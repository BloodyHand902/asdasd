...
class SendSms():
    ...
    def Dsmartgo(self):
        ...
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> dsmartgo.com.tr")

        except AttributeError:

            print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> dsmartgo.com.tr")
    ...
    def Kigili(self):    
        ...
        try:
            ...
            kigili = requests.post("https://www.kigili.com/register/?next=/", data={
            ...
            if kigili.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> kigili.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> kigili.com")
    ...
    def KahveDunyasi(self):    
        ...
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> core.kahvedunyasi.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> core.kahvedunyasi.com")
    ...
    def NaosStars(self):
        ...
        try:
            ...
            if naosstars.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> shop.naosstars.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> shop.naosstars.com")
    ...
    def Wmf(self):
        ...
        try:
            ...
            if wmf.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> wmf.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> wmf.com.tr")
    ...
    def IsteGelsin(self):
        ...
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> prod.fasapi.net")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> prod.fasapi.net")
    ...
    def Bim(self):
        ...
        try:
            ...
            if bim.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> bim.veesk.net")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> bim.veesk.net")
    ...
    def Sok(self):
        ...
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api.ceptesok.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api.ceptesok.com")
    ...
    def Tiklagelsin(self):
        ...
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> svc.apps.tiklagelsin.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> svc.apps.tiklagelsin.com")
    ...
    def Migros(self):
        ...
        try:
            ...
            if migros.json()["successful"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> rest.migros.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> rest.migros.com.tr")
    ...
    def A101(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> a101.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> a101.com.tr")
    ...
    def Englishhome(self):
        ...
        try:
            ...
            if home.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> englishhome.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> englishhome.com")
    ...
    def Sakasu(self):
        ...
        try:
            ...
            if su.json()["status"] == "ok":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> sakasu.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> sakasu.com.tr")
    ...
    def Rentiva(self): 
        ...
        try:
            ...
            if rentiva.json()["success"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> rentiva.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> rentiva.com")
    ...
    def Bineq(self):
        ...
        try:
            ...
            if bineq.json()["IsSuccess"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> bineqapi.heymobility.tech")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> bineqapi.heymobility.tech")
    ...
    def Link(self):
        ...
        try:
            ...
            if link.json()["detail"] == "Ok":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> consumer-auth.linkfleet.de")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> consumer-auth.linkfleet.de")
    ...
    def Lonca(self):
        ...
        try:
            ...
            if lonca.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> loncamarket.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> loncamarket.com")   
    ...
    def Dgn(self):
        ...
        try:
            ...
            if dgn.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> odeme.dgnonline.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> odeme.dgnonline.com")  
    ...
    def Yaani(self):
        ...
        try:
            ...
            if r.status_code == 204:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api.yaanimail.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api.yaanimail.com")  
    ...
    def Defacto(self):
        ...
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> defacto.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> defacto.com.tr")
    ...
    def Mopas(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> mopas.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> mopas.com.tr")
    ...
    def Icq(self):
        ...
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> u.icq.net")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> u.icq.net")
    ...
    def Boyner(self):
        ...
        try:
            ...
            json={"Captcha": "", "CaptchaTurn": False, "ConfirmNewPassword": "31ABC..abc31", "isGuestQuickBuy": "false", "Main": {"CellPhone": self.phone, "day": "31", "Email": self.mail, "FirstName": "Memati", "genderid": "1", "LastName": "Ba�", "month": "12", "ReceiveCampaignMessages": True, "year": 1972}, "MembershipAgreement": True, "MembershipAgreementClone": True, "NewPassword": "31ABC..abc31", "ReturnUrl": "/"}

            r = requests.post(url, headers=headers, json=json)

            if r.json()["Success"] == True:

                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> boyner.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> boyner.com")
    ...
    def Watsons(self):
        ...
        try:
            ...
            if r.status_code == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> watsons.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> watsons.com.tr")
    ...
    def Buyur(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> app.buyursungelsin.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> app.buyursungelsin.com")
    ...
    def Osmanlideal(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> osmgck.idealdata.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> osmgck.idealdata.com.tr")
    ...
    def Pinar(self):
        ...
        try:
            ...
            if r.text == "true":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> pinarsumobileservice.yasar.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> pinarsumobileservice.yasar.com.tr")
    ...
    def Suiste(self):
        ...
        try:
            ...
            if r.json()["code"] == "common.success":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> suiste.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> suiste.com")
    ...
    def Hayat(self):
        ...
        try:
            ...
            if (r.json()["IsSuccessful"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> hayatsu.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> hayatsu.com.tr")
    ...
    def Pisir(self):
        ...
        try:
            ...
            if r.json()["ok"] == "1":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api.pisir.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api.pisir.com")
    ...
    def KimGb(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
    ...
    def IkinciYeni(self):
        ...
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> apigw.ikinciyeni.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> apigw.ikinciyeni.com")
    ...
    def Terra(self):
        ...
        try:
            ...
            if (r.status_code) == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api.terrapizza.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api.terrapizza.com.tr")
    ...
    def IpraGaz(self):
        ...
        try:
            ...
            if (r.json()["phoneNumber"]) == str(self.phone):
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> ipapp.ipragaz.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> ipapp.ipragaz.com.tr")
    ...
    def Mogaz(self):
        ...
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> mogazmobilapinew.aygaz.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> mogazmobilapinew.aygaz.com.tr")
    ...
    def GoMobile(self):
        ...
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> gomobilapp.ipragaz.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> gomobilapp.ipragaz.com.tr")
    ...
    def PetrolOfisi(self):
        ...
        try:
            ...
            if r.status_code == 204:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> mobilapi.petrolofisi.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> mobilapi.petrolofisi.com.tr")
    ...
    def Total(self):
        ...
        try:
            ...
            if (r.json()["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> mobileapi.totalistasyonlari.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> mobileapi.totalistasyonlari.com.tr")
    ...
    def Opet(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api.opet.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api.opet.com.tr")
    ...
    def Dolap(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api-gateway.dolap.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api-gateway.dolap.com")
    ...
    def Hey(self):
        ...
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> heyapi.heymobility.tech")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> heyapi.heymobility.tech")
    ...
    def Tazi(self):
        ...
        try:
            ...
            if (r.json()["kod"]) == "0000":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> mobileapiv2.tazi.tech")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> mobileapiv2.tazi.tech")
    ...
    def Isbike(self):
        ...
        try:
            ...
            if (r.json()["sonuc"]["aciklama"]) == "��lem Ba�ar�l�":

                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> app.isbike.istanbul")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> app.isbike.istanbul")
    ...
    def N11(self):
        ...
        try:
            ...
            if (r.json()["isSuccess"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> mobileapi.n11.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> mobileapi.n11.com")
    ...
    def Joker(self):
        ...
        try:
            ...
            if (r.json()["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> joker.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> joker.com.tr")
    ...
    def Ebebek(self):
        ...
        try:
            ...
            if r.json()["status"] == "SUCCESS":
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api2.e-bebek.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api2.e-bebek.com")
    ...
    def Saka(self):
        ...
        try:
            ...
            if (r.json()["status"]) == 1 :
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> mobilcrm2.saka.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> mobilcrm2.saka.com.tr")
    ...
    def Gofody(self):
        ...
        try:
            ...
            if (r.json()["success"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> backend.gofody.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> backend.gofody.com")
    ...
    def Madame(self):
        ...
        try:
            ...
            if (r.status_code) == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> madamecoco.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> madamecoco.com")
    ...
    def Buludag(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> bilet.balikesiruludag.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> bilet.balikesiruludag.com.tr")   
    ...
    def Evidea(self):
        ...
        try:
            ...
            if r.status_code == 202:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> evidea.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> evidea.com")
    ...
    def Koctas(self):
        ...
        try:
            ...
            if (r.json()["status"]) == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> occ2.koctas.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> occ2.koctas.com.tr")
    ...
    def Gratis(self):
        ...
        try:
            ...
            if (r.status_code) == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> ivt.mobildev.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> ivt.mobildev.com")
    ...
    def Anadolu(self):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> anadolu.com.tr")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> anadolu.com.tr")
    ...
    def Accordors(self):
        ...
        try:
            ...
            if r.json()["data"]:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> aouws.accordors.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> aouws.accordors.com")
    ...
    def Marti(self):
        ...
        try:
            ...
            if r.json()["isSuccess"] == True:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> customer.martiscooter.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> customer.martiscooter.com")
    ...
    def Hop(self):
        ...
        try:
            ...
            if r.status_code == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api.hoplagit.com")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api.hoplagit.com")
    ...
    def Karma(self):
        ...
        try:
            ...
            if r.status_code == 201:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Ba�ar�l�! {self.phone} --> api.gokarma.app")
            ...
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Ba�ar�s�z! {self.phone} --> api.gokarma.app")
